...
<head>
	...
	<title><c:forEach var="cus" items="${cusDetails}">${cus.name}</c:forEach> | Account</title>
</head>
...
<body>
	...
	<!--=======================Header Start=======================-->
        <header>
            <div class="nav-bar">
                <div class="logo"><h3>BUS TIKER</h3></div>
                <div class="navigation">
                    <div class="nav-items">
                    	<a><c:forEach var="cus" items="${cusDetails}">${cus.name}</c:forEach></a>
                        <a href="#">BOOK NOW</a>
                        <a href="#">VIWE MY BOOKING</a>
